...
public class CommandHandler {
    ...
    private String create(List<String> arguments) {
        if (arguments.size() < 2) {
            return String.format(INVALID_ARGS_COUNT_MESSAGE_FORMAT, GET + " "
                    + ALL, "at least 2", "s", CREATE + "<cocktailName> <ingredient1> ... <ingredientN>");
        }
    ...
    private String getByName(List<String> arguments) {
        if (arguments.size() != 2) {
            return String.format(INVALID_ARGS_COUNT_MESSAGE_FORMAT, GET + " "
                    + BY_NAME, 1, "", GET + " " + BY_NAME + " <cocktailName>");
        }
    ...
    private String getByIngredient(List<String> arguments) {
        if (arguments.size() != 2) {
            return String.format(INVALID_ARGS_COUNT_MESSAGE_FORMAT, GET + " "
                    + BY_INGREDIENT, 1, "", GET + " " + BY_INGREDIENT + " <ingredientName>");
        }
